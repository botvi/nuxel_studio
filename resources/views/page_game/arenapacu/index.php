...
<head>
    ...
    <script>
        window.onerror = function (message, source, lineno, colno, error) {
            ...
            errorDiv.innerHTML = '<h3>JS Error:</h3>' + message + '<br>at ' + source + ':' + lineno + ':' + colno + '<br><br>' + (error ? error.stack : '');
    ...
    <script>
        ...
        class ArenaScene extends Phaser.Scene {
            ...
            create() {
                ...
                // Terapkan Corak & Ekor Pemain dari Database
                ...
                const drawBackBtnBg = (fillAlpha, lineAlpha, lineWidth) => {
                    backBtnBg.clear();
                    if (this.isMultiplayer) {
                        // Hilangkan backgroundnya (jangan diisi apa-apa)
                        return;
                    }
                ...
                if (this.isMultiplayer) {
                    // Buat animasi whiteflag jika belum ada
                ...
                const countdownTimer = this.time.addEvent({
                    ...
                    callback: () => {
                        if (count > 0) {
                            ...
                            // Play start audio (pluit loops, low volume)
            ...
            showRaceResult(isWinner) {
                ...
                // Detil Hadiah Koin (koin sudah ditambahkan secara real-time saat tap perfect)
            ...
            update(time, delta) {
                ...
                if (this.gameState === 'racing') {
                    ...
                    // Play supporter sound when passing a pancang (post)
                    ...
                    // Send throttled sync status to server (every 100ms)
                    if (this.isMultiplayer && this.ws && this.ws.readyState === WebSocket.OPEN) {
